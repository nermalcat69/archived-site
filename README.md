![Eva designs and builds things for the web.](https://raw.githubusercontent.com/evadecker/arjunaditya.xyz/main/public/og/default.png)
...
[![Check Links](https://github.com/evadecker/arjunaditya.xyz/actions/workflows/links.yml/badge.svg)](https://github.com/evadecker/arjunaditya.xyz/actions/workflows/links.yml)

A weekly [GitHub workflow](https://github.com/evadecker/arjunaditya.xyz/actions/workflows/links.yml) scans the site for broken links and will open an issue if one is found.

## Accessibility

[![CI](https://github.com/evadecker/arjunaditya.xyz/actions/workflows/ci.yml/badge.svg)](https://github.com/evadecker/arjunaditya.xyz/actions/workflows/ci.yml)

Every pull request is tested for automatically-detectable accessibility issues and HTML5 compliance.

This site aims to conform to the Level AA accessibility standards outlined in the [WCAG 2.2 specification](https://www.w3.org/TR/WCAG22/). If you experience an issue with accessing any part of this site, please [file an issue](https://github.com/evadecker/arjunaditya.xyz/issues) and I’ll do my best to correct it.
...
Frontmatter for content should include a required `datePublished` and an optional `dateModified` field. Dates should be ISO-formatted datetime strings and _include the time zone of publishing_, like this: `2023-09-26 03:47:00-04:00`.
